...
from .models import AttributeOpValue, GroupUser, UserGroup
...
class HuntGroupUpdate(BaseModel):
    groupname: Annotated[str, StringConstraints(min_length=1)] | None = None
    nasipaddress: Annotated[str, StringConstraints(min_length=1)] | None = None
    nasportid: Annotated[str, StringConstraints(min_length=0)] | None = None
