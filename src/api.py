...
from router import default_router, groups_router, huntgroups_router, nas_router, radacct_router, users_router
...
app.include_router(radacct_router, prefix="/api/v1")
